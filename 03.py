...
def using_conditionals():
  answer = ""
  for i in range(5, len(text) - 4):
    c = text[i]
    is_lower = c.islower()
    has_guards_left = text[i-1].isupper() and text[i-2].isupper() and text[i-3].isupper()
    has_guards_right = text[i+1].isupper() and text[i+2].isupper() and text[i+3].isupper()
    exactly_three_guards = text[i-4].islower() and text[i+4].islower()
    if is_lower and has_guards_left and has_guards_right and exactly_three_guards:
      answer += c
  return answer

print("Solution using loops and conditions:")
print(using_conditionals())
print()
print("Solution using regex:")
print(using_regex())
print()
print("http://pythonchallenge.com/pc/def/" + using_regex() + ".html")